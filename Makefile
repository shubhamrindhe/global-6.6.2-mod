...
CONFIG_CLEAN_FILES = gtags.conf Doxyfile
...
am__installdirs = "$(DESTDIR)$(gtagsdir)"
DATA = $(gtags_DATA)
...
CTAGS = ctags
CSCOPE = cscope
DIST_SUBDIRS = libglibc libutil libparser libltdl plugin-factory libdb \
	global gozilla gtags htags htags-refkit htags-server globash \
	doc icons jquery jquery/images script gtags-cscope
am__DIST_COMMON = $(srcdir)/Doxyfile.in $(srcdir)/Makefile.in \
	$(srcdir)/config-h.in $(srcdir)/gtags.conf.in AUTHORS COPYING \
	COPYING.LIB ChangeLog INSTALL NEWS README THANKS compile \
...
ACLOCAL = ${SHELL} /home/sanket/Desktop/spd/global-6.6.2/missing aclocal-1.15
ALLOCA = 
AMTAR = $${TAR-tar}
AM_CPPFLAGS = -I$(top_srcdir)/libparser $(LTDLINCL) -I$(top_srcdir)/libutil -I$(top_srcdir)/libdb -I$(top_srcdir)/libglibc -I../libutil
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/sanket/Desktop/spd/global-6.6.2/missing autoconf
AUTOHEADER = ${SHELL} /home/sanket/Desktop/spd/global-6.6.2/missing autoheader
AUTOMAKE = ${SHELL} /home/sanket/Desktop/spd/global-6.6.2/missing automake-1.15
AWK = gawk
CC = gcc
...
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/sanket/Desktop/spd/global-6.6.2/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE_STRING = GNU GLOBAL 6.6.2
...
UNIVERSAL_CTAGS = 
VERSION = 6.6.2
abs_builddir = /home/sanket/Desktop/spd/global-6.6.2
abs_srcdir = /home/sanket/Desktop/spd/global-6.6.2
abs_top_builddir = /home/sanket/Desktop/spd/global-6.6.2
abs_top_srcdir = /home/sanket/Desktop/spd/global-6.6.2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/sanket/Desktop/spd/global-6.6.2/install-sh
...
SUBDIRS = libglibc libutil libparser libltdl plugin-factory \
	$(am__append_1) global gozilla gtags htags htags-refkit \
	htags-server globash doc icons jquery jquery/images script \
	$(am__append_2)
gtagsdir = ${datadir}/gtags
gtags_DATA = AUTHORS COPYING COPYING.LIB ChangeLog FAQ INSTALL LICENSE NEWS README THANKS \
	DONORS BUILD_TOOLS README.PATCHES \
        gtags.conf gtags.el gtags.pl gtags.vim gtags-cscope.vim \
	elvis.rc elvis-2.2_0.patch geco.rc \
...
gtags.conf: $(top_builddir)/config.status $(srcdir)/gtags.conf.in
...
installdirs-am:
	for dir in "$(DESTDIR)$(gtagsdir)"; do \
...
install-data-am: install-gtagsDATA
...
uninstall-am: uninstall-gtagsDATA
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am \
	...
	install-gtagsDATA install-html install-html-am install-info \
